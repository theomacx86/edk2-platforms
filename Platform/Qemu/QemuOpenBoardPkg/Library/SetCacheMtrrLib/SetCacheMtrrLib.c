  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "PcdFlashAreaBaseAddress %x PcdFlashAreaSize %x \n", (UINTN) PcdGet32 (PcdFlashAreaBaseAddress), (UINTN) PcdGet32 (PcdFlashAreaSize) ));
